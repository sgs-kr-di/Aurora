...
namespace Sgs.ReportIntegration
{
    public partial class CtrlEditBom : UlUserControlEng
    {
        ...
        private void bomGridView_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                MessageBox.Show(f.Message + Environment.NewLine + Environment.NewLine + Environment.NewLine + f.Source);
            }
        ...
        private void LoadExcel()
        {
            ...
            if (curFName != newFName)
            {
                ...
                {
                    MessageBox.Show(e.Message + Environment.NewLine + Environment.NewLine + e.Source);
                }
                finally
                {
